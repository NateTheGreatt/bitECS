...
export declare function queryHierarchy(world: World, relation: ComponentRef, components: ComponentRef[]): readonly EntityId[];
export declare function queryHierarchyDepth(world: World, relation: ComponentRef, depth: number): readonly EntityId[];
