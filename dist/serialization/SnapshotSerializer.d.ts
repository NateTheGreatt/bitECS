...
export declare const createSnapshotDeserializer: (world: World, components: Record<string, PrimitiveBrand>[], entityIdMap?: Map<number, number>) => (packet: ArrayBuffer) => Map<number, number>;
