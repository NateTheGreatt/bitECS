...
describe("AoS DataWriter", () => {
  describe("snapshot mode", () => {
    it("should writeComponent", () => {
      ...
      strictEqual(writeView.cursor, 3 * Float32Array.BYTES_PER_ELEMENT);
    ...
    it("should writeEntity", () => {
      ...
      strictEqual(
        writeView.cursor,
        1 * Uint32Array.BYTES_PER_ELEMENT + 6 * Float32Array.BYTES_PER_ELEMENT
      );
  ...
  describe("delta mode", () => {
    it("should writeComponent", () => {
      ...
      strictEqual(
        writeView.cursor,
        1 * Uint8Array.BYTES_PER_ELEMENT + 2 * Float32Array.BYTES_PER_ELEMENT
      );
